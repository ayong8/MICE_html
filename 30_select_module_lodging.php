...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>div 태그</title>
			...
			<link href="30_select_module_lodging.css" rel="stylesheet" type="text/css" />
	</head>
...
			<div id="sidebar">
			...
			<div id="contents">
				...
				<hr size="1" width="100%"></hr>
				<p class="p_">
					<span class="span_day">Day 3</span>
					<span class="span_drag_module">
						<span class="span_module">Lodging</span>
				...
				<ul class="ul_txtbox">
					<li><input type="text" id="txtbox1" class="txtbox1" value="Check-In & Out"></li>
					<li><input type="text" id="txtbox1" class="txtbox2" value="Hotel or Grade"></li>
					<li><input type="text" id="txtbox1" class="txtbox3"></li>
					<li><input type="text" id="txtbox1" class="txtbox4"></li>
					<li><input type="text" id="txtbox1" class="txtbox5"></li>
